...
export const WithdrawalScreen = () => {
  ...
  const [payoutMethods] = useState<any[]>([
    { id: '1', type: 'MOMO', provider: 'MTN MoMo', accountNumber: '0551234321', isDefault: true, icon: 'phone-portrait-outline', badgeColor: '#FF6B35' },
    { id: '2', type: 'MOMO', provider: 'Vodafone Cash', accountNumber: '0209876543', isDefault: false, icon: 'phone-portrait-outline', badgeColor: '#E60000' },
    { id: '3', type: 'BANK', provider: 'Absa Ghana', accountNumber: '1234567890', isDefault: false, icon: 'card-outline', badgeColor: '#D32F2F' }
  ]);
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      showToast({
        ...
        subtitle: `${numericAmount.toFixed(2)} GHS has been sent to your account.`
      });
      navigation.canGoBack() ? navigation.goBack() : (navigation as any).navigate('Main');
    } catch (error: any) {
      Alert.alert('Error', error.response?.data || error.message || 'Failed to complete withdrawal');
    } finally {
    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        >
          ...
          <View style={styles.headerBar}>
            ...
            <View style={styles.headerTextWrap}>
              ...
              <Text style={[styles.pageSubtitle, { color: colors.textMuted }]}>
                Transfer wallet balance directly to your mobile money or bank
              </Text>
            </View>
          </View>
          ...
          >
            <Text style={[styles.amountLabel, { color: colors.primary }]}>ENTER WITHDRAWAL AMOUNT</Text>
          ...
          <View style={styles.sectionHeader}>
            ...
            <Text style={[styles.sectionTitle, { color: colors.text }]}>Select Payout Destination</Text>
          </View>
                  ...
                  <View style={styles.methodLeft}>
                    ...
                    <View style={styles.methodInfo}>
                      ...
                      <Text style={[styles.methodAccount, { color: colors.textMuted }]}>
                        Account: **** {item.accountNumber.slice(-4)}
                      </Text>
                    </View>
                  </View>
          ...
          >
            {isSubmitting ? (
              ...
              <>
                ...
                >
                  {isValidAmount ? `Withdraw GHS ${currentNumericAmount.toFixed(2)}` : 'Enter Amount to Withdraw'}
                </Text>
                {isValidAmount && (
